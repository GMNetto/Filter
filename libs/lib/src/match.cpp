...
void MatchKey::set_icp(CustomICP<pcl::PointXYZRGBNormal, pcl::PointXYZRGBNormal> &local_icp) {
        ...
        rej_sample_local->setInlierThreshold(icp.getMaxCorrespondenceDistance());
        ...
        local_icp.setRANSACOutlierRejectionThreshold(icp.getMaxCorrespondenceDistance());
